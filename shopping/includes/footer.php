...
<h3>shopHuB</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> this project design by modit and deepali and developed by hemant...</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(91) 9351733774<br>(91) 7300283729</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">hemantgautam505@gmail.com</a></span>
                </div>
            </li>
